...
mongoose.connect('mongodb+srv://Felipe:V8KivXwAUCcVT5Qy@felipelima.dqqudak.mongodb.net/Alura?retryWrites=true&w=majority',{useNewUrlParser: true, useUnifiedTopology: true}).then(function(){
...
app.post('/admin/cadastro',(req,res)=>{
    ...
    if(formato[formato.length - 1] == "jpg","png","jpeg"){
        imagem = new Date().getTime()+'.jpg','.png','.jpeg'
